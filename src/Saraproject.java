...
public class Saraproject
{
    public static void main(String[] args) throws  IOException
    {
   	Scanner in=new Scanner(System.in);
   	FileWriter fw = new FileWriter("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\amal.txt",true);
        PrintWriter out = new PrintWriter(fw);
	FileReader fr = new FileReader("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\amal.txt");
        ...
        case 1:
               ...
               for(;;){
				...
				else if (case1 == 4)
				{
					...
					amal.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\amal.txt");
					System.out.println("ALL GOOD BOOKS");
					amal.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\book.txt");
					System.out.println("ALL BAD BOOKS");
					amal.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\1badbook.txt");
				}//Report
				else  // Exit
					 System.exit(0);
				}//end for
             ...
             if (case2 == 1)
               {
				...
				{
					System.out.println("ALL USERS");
					raja.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\raja.txt");
					System.out.println("ALL GOOD TOOLS");
					raja.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\tools.txt");
					System.out.println("ALL BAD TOOLS");
					raja.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\badtools.txt");
				}//Report
				else  // Exit
				System.exit(0);
	...
	System.out.println("Intenet is vailbei with a fee of 40 % of the Subscribption fee ");
		...
		System.out.println("  How many studant in groub");
	     int numbre =in.nextInt();
	 					...
	 					duaa.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\SingaleReading.txt");
	 					System.out.println("ALL RegistGroup ");
	 					duaa.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\GroupReading.txt");
	 }
	 else
	      System.exit(0);
...
if(case4 == 1){
	System.out.println("***************************** Ai AMAL Reports******************************************");
                           System.out.println("ALL USERS");
							...
							amal.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\book.txt");
							System.out.println("ALL BAD BOOKS");
					            amal.report("C:\\Users\\Hussein_Salih\\Documents\\NetBeansProjects\\saraproject\\src\\saraproject\\badbook.txt");
}
else if(case4 == 2){
